...
//        setData() - will update the entire document or
//        updateData() - can update selected field in the document
...
//                .document(documentID)
//                .setData(from: self.movieList[indexToUpdate])
//
//            print(#function, "Document successfully overwritten with updated values")
//        }catch let err as NSError{
//            print(#function, "Unable to set document with updated data due to error  : \(err)")
//        }
